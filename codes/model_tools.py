...
#There might be some bugs for models with different number of countries, especially in Analysis section and with regard of foreign currency accounts of banks (WTO accounts).
